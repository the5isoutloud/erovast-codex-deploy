...
Per [[Cassian]]'s Medicine check (15):
- **Natural recovery**: 6 nights of long rest.
- **Clerical care once a day**: cuts recovery to 3 nights.
- **Clerical care multiple times a day**: cuts recovery to 2 nights.
- **A rare restorative concoction** exists but costs roughly **2,000–4,000 gp**.
- A cleric or paladin could also cast (implicitly Greater Restoration) to remove one exhaustion level per casting, once per long rest.
